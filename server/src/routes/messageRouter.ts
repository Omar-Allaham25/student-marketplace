...
import { checkConversationSchema, createMessageSchema, deleteMessageSchema, getConversationMessagesSchema } from "../validators/messageValidator";
...
router.get("/conversation/:listingId", validate(checkConversationSchema), checkConversation);
